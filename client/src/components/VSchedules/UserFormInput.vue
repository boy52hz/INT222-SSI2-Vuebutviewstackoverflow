...
<template>
    <app-modal :show="modalState.state">
        <form 
        @submit.prevent="$emit('add-user')"
        @reset.prevent="$emit('cancel-form')"
        >
        <h3>Create New Account</h3>
            <div>
                ...
                <div class="app-button-group">
                    ...
                    <app-button class="btn-cancel" button-type="danger" type="reset" @click="modalState.close()">Cancel</app-button>
                </div>
            </div>
        </form>
    </app-modal>
