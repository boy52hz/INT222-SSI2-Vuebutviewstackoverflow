...
public class AadResourceServerUtils implements ProviderRegistrar {
    ...
    public void registerProvider(JwtAuthenticationManagerResolver authenticationManagerResolver) {
        aadTrustedIssuerRepository().getTrustedIssuers().forEach(issuer -> authenticationManagerResolver.addAuthenticationManager(issuer, jwtAuthenticationProvider()));
    }
