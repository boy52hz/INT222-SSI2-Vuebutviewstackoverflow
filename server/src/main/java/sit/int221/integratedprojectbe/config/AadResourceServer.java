...
public class AadResourceServer implements ProviderRegistrar {
    ...
    public void registerProvider(JwtIssuerAuthenticationManagerResolverImp authenticationManagerResolver) {
